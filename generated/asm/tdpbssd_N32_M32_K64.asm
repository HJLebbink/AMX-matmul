...
;----------------------------------------------------------------------------
; extern "C" void tdpbssd_N32_M32_K64_asm(void *c, void* a, void* b); //RCX, RDX, R8, R9
GLOBAL tdpbssd_N32_M32_K64_asm

SECTION .text
tdpbssd_N32_M32_K64_asm:
 ...
 ; C[1][1] += A[0][1] * B[0][1]
  ...
  tileloadd   tmm4, [rdx + r10 + 0]			    ; load A[0][0]
  tileloadd   tmm5, [rdx + r10 + 1024]		    ; load A[0][1]
  tileloadd   tmm6, [r8  + r10 + 0]			    ; load B[0][0]
  tileloadd   tmm7, [r8  + r10 + 1024]			; load B[0][1]
